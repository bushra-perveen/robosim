...
public class WorldBuilder extends JDialog implements ActionListener {
	...
	void initGUI() {
		...
		pnlSouth.add(UIUtils.createSpinnerPanel("No of Columns", spnCols, world[0].length, HistogramFilterView.MIN_NO_OF_COLUMNS,
				HistogramFilterView.MAX_NO_OF_COLUMNS, 1));
